<div class="min-w-96 max-w-1/2 basis-1/3 flex-1 min-h-48">
    <div class="items-center px-2 min-h-[150px] w-full bg-white md:flex-row">
        <img class="float-left pr-2 w-[150px] max-w-full h-[150px] max-h-full object-cover" src="{{ $post->thumbnail ? asset('storage/' . $post->thumbnail) : asset('images/o1.png')}}" alt="Pressglobal">
