    ...
    <main class="flex flex-col justify-center items-center w-full">
        ...
        <section class="bg-zinc-100 bg-opacity-25 min-h-72 px-4 w-full">
            <div class="flex flex-nowrap flex-col md:flex-row justify-center py-8 w-full md:space-x-12 space-y-12 md:space-y-0">
                <x-info-square bgColor="border-sky-400"
                    header="Praktyki uczelniane i nie tylko"
                ...
                <x-info-square bgColor="border-green-400"
                    header="Fundacja na rzecz promocji i rozwoju Głos Młodych"
                ...
                <x-info-square bgColor="border-fuchsia-600"
                    header="Realizując praktyki uczelniane uwzględniamy"
        ...
        <section class="w-full relative">
            <div class="relative w-full max-w-full min-h-40 mx-auto h-full md:h-[450px] lg:w-[1470px] bg-[url('./images/licznik22.png')] bg-cover">
                <div class="grid lg:grid-cols-8 gap-y-20 md:gap-4 text-white text-center h-full w-full py-8">
                    ...
                    <div class="col-start-4 md:col-start-2 md:col-span-2 text-3xl">Zrealizowaliśmy <br><strong class="text-5xl">3768</strong><br> praktyk</div>
                    <div class="col-start-4 md:col-span-2 text-3xl">w tym <br><strong class="text-5xl">3242</strong><br> praktyk uczelnianych</div>
                    <div class="col-start-4 md:col-start-6 md:col-span-2 text-3xl" >Współpracujemy z <br><strong class="text-5xl">70</strong><br> osobami</div>
                    <div class="col-start-4 md:col-start-1 md:col-span-8 text-xl">Z zakresu dziennikarstwa, redakcji, tłumaczeń, moderowania, programowania -różne technologie, reklamy, social mediów, administracji systemów serwerowych, fotografii, ogólnie rozumianej grafiki , HR-u, administracji.</div>
                </div>
        ...
        <section>
            <div class="grid lg:grid-cols-2 items-start w-full max-w-full xl:max-w-[1470px] mx-auto my-4">
                <div class="space-x-2 flex flex-col mb-12">
                    ...
                    <div class="text-center font-semibold text-blue-600"><a href="/aktualnosci">Zobacz Wszystkie</a></div>
                </div>
